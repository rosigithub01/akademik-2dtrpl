  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMain">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?= in_array($page,['mahasiswa','create_mhs','edit_mhs']) ? 'active' : '' ?>" href="index.php?page=mahasiswa">Data Mahasiswa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= $page=='prodi' ? 'active' : '' ?>" href="index.php?page=prodi">Prodi</a>
        </li>
      </ul>
    </div>
  </div>
